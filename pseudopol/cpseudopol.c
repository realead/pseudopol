...
static PyObject *__pyx_pw_10cpseudopol_1find_max_subsum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("find_max_subsum (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_objects)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("find_max_subsum", 1, 2, 2, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "find_max_subsum") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_max_sum = __Pyx_PyInt_As_unsigned_PY_LONG_LONG(values[0]); if (unlikely((__pyx_v_max_sum == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_objects = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_int(values[1]); if (unlikely(!__pyx_v_objects.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  }
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyInt_FromSize_t(find_max(__pyx_t_1, (&(*((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_objects.data) + __pyx_t_2)) )))), __pyx_v_max_sum)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 7, __pyx_L1_error)
